    ...
    <div class="row">
        <div class="col-md-12">
            <div class="pull-right">
                <a href="<?php echo base_url('product/add/product') ?>" class="btn btn-primary">Add Product</a>
            </div>
        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <div class="btn-group pull-right">
                                <button class="btn btn-xs btn-<?php echo ($product->enabled) ? 'primary' : 'danger' ?> dropdown-toggle" data-toggle="dropdown"><span class="caret"></span></button>
                                <ul class="dropdown-menu pull-right">
                                    <li>
                                        <a href="<?php echo base_url('product/edit/product/' . $product->id) ?>">Edit</a>
                                    </li>
                                    <?php if (($product->enabled)): ?>
                                        <li><a href="<?php echo base_url('product/disable/product/' . $product->id) ?>">Disable</a></li>
                                    <?php else: ?>
                                        <li><a href="<?php echo base_url('product/enable/product/' . $product->id) ?>">Enable</a></li>
                                    <?php endif ?>
                                </ul>
                            </div>
                            <div class="clearfix"></div>
